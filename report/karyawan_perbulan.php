...
<html>
    <head>
        <title>Cetak Data Kayawan Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <h2>Sistem Informasi Pembukaan Rekening Baru Bank ABC </h2>
                        <hr>
                        <h3>DATA PEMINJAMAN KARYAWAN BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <tr>
                            ...
                            $sql = "SELECT * FROM karyawan WHERE month(tgl_lahir)='$ambilbln' AND year(tgl_lahir)='$ambilthn'";

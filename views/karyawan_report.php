            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                        <tr>
                                <th>No.</th><th class="text-center">Nama</th><th class="text-center">Alamat</th><th class="text-center">Jenis Kelamin</th><th class="text-center">Jabatan</th><th class="text-center">Tanggal Lahir</th><th>ACTIONS</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <td><?= $nomor ?></td>
                                    ...
                                    <td>
                                        <a href="report/karyawan_satu.php?id=<?= $data['id_karyawan'] ?>" target="_blank" class="btn btn-info btn-xs">
